        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $dossier->plaque }} / {{ $dossier->client->name }}
                            </li>
                        </ul>
                    </div>
                    @if ($dossier->status === 1)
                    ...
                    <div class="col-auto float-end ms-auto">
                        <a href="{{ route('print.details', ['id' => $id_dossier]) }}" class="btn add-btn"
                            id="add_client"><i class="fa fa-print"></i>Imprimer</a>
                    </div>

                    @if ($id_dossier != 23)
                        @if ($dossier->status === 1)
                            <div class="col-auto float-end ms-auto">
                                <button onclick="closeFolder({{ $id_dossier }})" class="btn alert-danger"
                                    id="add_client"><i class="fa fa-delete"></i>Cloturer</button>
                            </div>
                        @endif
                    @endif
                                ...
                                <div class="card dash-widget">
                                    <div class="card-body">
                                        ...
                                        <div class="dash-widget-info">
                                            <h3>{{ isset($solde_caisse) ? number_format($solde_caisse->amount_usd) : 0 }}
                                                $
                                            </h3>
                                            <span> </span>
                                        </div>
                            ...
                            <a href="">
                                <div class="card dash-widget">
                                    <div class="card-body">
                                        ...
                                        <div class="dash-widget-info">
                                            <h3>{{ isset($solde_caisse) && isset($solde_caisse->amount_cdf) ? number_format($solde_caisse->amount_cdf) : 0 }}
                                                CDF</h3>
                                            <span> </span>
                                        </div>
                                    </div>
            ...
            @if (session()->has('message'))
                <div class="alert alert-success">
                    {{ session('message') }} <a href="{{ route('ticket.details', ['id' => $op_print]) }}">
                        Imprimer le
                        recu</a>
                </div>
            @endif
